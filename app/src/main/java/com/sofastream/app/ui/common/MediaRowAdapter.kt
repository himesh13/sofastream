...
import com.sofastream.app.databinding.ItemMediaCardBinding

class MediaRowAdapter(
    private val onItemClick: (MediaItem) -> Unit
) : ListAdapter<MediaItem, MediaRowAdapter.ViewHolder>(DiffCallback()) {
    ...
    inner class ViewHolder(private val binding: ItemMediaCardBinding) :
        ...
        fun bind(item: MediaItem) {
            ...
            if (item.playedPercentage > 0) {
                binding.progressBar.progress = item.playedPercentage.toInt()
